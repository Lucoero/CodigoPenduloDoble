...
kp = 1   # Constante elástica del muelle que une ambas masas
...
z2_0 = 0.1  # Desplazamiento inicila masa 2
...
Ep = 1/2 * k * z[:, 0]**2 + 1/2 * k * z[:, 1]**2 + 1/2 * kp * (z[:, 0]-z[:, 1])**2  
...
fig.suptitle("Desplazamientos respecto al tiempo", fontsize = 25)
ax2 = ax1.twinx()
