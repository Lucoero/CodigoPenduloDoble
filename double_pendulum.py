...
fig.suptitle("Espacio real")
ax2 = ax1.twinx()
ax1.set_xlabel('time (s)')
ax1.set_ylabel('$\\theta_1$(rad)', color='b', fontsize=10)
ax2.set_ylabel('$\\theta_2$(rad)', color='r', fontsize=10)
...
# ENERGIAS
fig, ax3 = plt.subplots()
fig.suptitle("Energias")
ax4 = ax3.twinx()
ax3.set_xlabel('$t$ (s)')
ax3.set_ylabel('$T (J)$', color = "b",fontsize=10)
ax4.set_ylabel("U (J)", color = "r")
ax3.tick_params('y', colors='b')
ax4.tick_params("y", colors="r") 
line1, = ax3.plot(t,T, linewidth=2, color='b')
line2, = ax4.plot(t,U, linewidth=2, color='r')
